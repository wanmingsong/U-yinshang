...
public class APDUCmd implements Parcelable {
	...
	public static final Parcelable.Creator<APDUCmd> CREATOR = new Creator<APDUCmd>() {

		@Override
		public APDUCmd createFromParcel(Parcel source) {
		...
		@Override
		public APDUCmd[] newArray(int size) {
			return new APDUCmd[size];
		}
	};
