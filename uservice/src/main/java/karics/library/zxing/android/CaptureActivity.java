...
public final class CaptureActivity extends Activity implements
    ...
    private InnerScannerStub scanner;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        try {
            scanner.getOnScannerListener().onScanResult(-2001, null);
    ...
    public void onCreate(Bundle icicle) {
        ...
        hasSurface = false;
        scanner = InnerScannerStub.getInstance(this);//获得单例对象实例
        timeout = scanner.getTimeout();//获得超时时间
        listener = scanner.getOnScannerListener();//获得监听器对象
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        if (fromLiveScan) {
            ...
            try {
                if (timeout > 0) {
                    listener.onScanResult(0, text.getBytes());
                }
            } catch (RemoteException e) {
                e.printStackTrace();
            }
